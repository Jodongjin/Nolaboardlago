...
public class davincicodeReviewActivity extends AppCompatActivity {

    Integer loginState = 0; // 로그인 상태: 0이면 비로그인, 1이면 로그인

    // DataBase
    davincicodeDBHelper DBHelper = new davincicodeDBHelper(this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.davincicodereview);
        setTitle("게임리뷰");
        ...
        writeReviewBtn.setOnClickListener(new View.OnClickListener() { // 리뷰작성 버튼 클릭 시
            ...
            public void onClick(View v) {
                ...
                if(loginState == 0) { // 비로그인 상태라면
                    View dialogView = (View) View.inflate(davincicodeReviewActivity.this, R.layout.logindialog, null);
                    AlertDialog.Builder dlg = new AlertDialog.Builder(davincicodeReviewActivity.this);
                    ...
                    if(comment.getText().toString().isEmpty()) {
                        ...
                        sqlDB.execSQL("INSERT INTO davincicodeTBL VALUES ('" + comment.getText().toString() + "', '" + ratingBar.getRating() + "');");
                        sqlDB.close();
